...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        error = y[None,:]-final_outputs[None,:]# Output layer error is the difference between desired target and actual output.
        print("error",error)
        print(type(self.weights_hidden_to_output))
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = np.dot(error,np.transpose(self.weights_hidden_to_output))
        ...
        delta= output_error_term * hidden_outputs.T
    

        delta_weights_h_o += delta.T
